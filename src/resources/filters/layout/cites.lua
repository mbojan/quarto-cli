...
function citesPreprocess() 
  return {
    ...
    Note = function(note) 
      if _quarto.doc.isLatexOutput() and marginCitations() then
    ...
    Para = function(para)
      ...
      if figure and _quarto.doc.isLatexOutput() and hasFigureRef(figure) then
    ...
    Div = function(div)
      if _quarto.doc.isLatexOutput() and hasMarginColumn(div) or marginCitations() then
